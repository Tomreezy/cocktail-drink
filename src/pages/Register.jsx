    ...
    return (
        ...
        <form className=" bg-white w-[80vw] max-w-96 rounded-sm shadow-md overflow-hidden ">
            ...
            <div className="space-y-2 mb-2 mt-8">
                ...
                <input id="Email" type="email" className="bg-blue-100 outline-none border border-blue-500 border-solid w-full rounded-sm px-3 py-1" />
            </div>
            ...
            <p className="text-center">Already a member? <span className="text-blue-500"><NavLink to={"/User/login"}>Login</NavLink></span></p>
            </div>
        </form>
    </div>
    )
